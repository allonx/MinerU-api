...
async def pdf_parse_main(
    ...
    try:
        ...
        return JSONResponse(content={"success": True, "infer time": infer_time}, status_code=200)
        ...
        #threading.Timer(2*60, os.unlink, args=(output_path,)).start()
        #logger.info("The output files had Clean up!")
